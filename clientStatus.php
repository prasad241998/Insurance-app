...
echo '</div>';
	...
	echo "    <th>COMPASSION VISIT</th>\n";
	echo "    <th>AMBULANCE COVER</th>\n";
	echo "    <th>TOTAL AMOUNT</th>\n";
    echo "  </tr>";
	...
	while($row = $result->fetch_assoc()) {
		...
		echo "    <td>".$row["compassion_visit"]."</td>\n";
		echo "    <td>".$row["ambulance_cover"]."</td>\n";
	...
	echo "</br>\n";
	echo "</br>\n";
	echo '<b>PLAN DETAILS</b>'; echo '&nbsp';echo '&nbsp';echo '&nbsp';
