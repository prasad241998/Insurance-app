...
<?php
	...
	$sql = "INSERT INTO client "."VALUES('$client_id', '$client_password', '$name', '$sex', '$birth_date', '$marital_status', '$nid', '$aadhar_number', '$phone', '$address','$start_date', '$end_date', '$due_date', '$policy_id', '$agent_id','$profileImage','$email_id')";
